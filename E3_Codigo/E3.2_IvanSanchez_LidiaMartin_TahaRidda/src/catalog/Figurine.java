...
public class Figurine extends Product implements java.io.Serializable {
     ...
     */
    public Figurine(String name, String description, double price, ArrayList<String> image, int stock, ArrayList<Category> categories, ArrayList<Review> reviews, IDiscount discount, double height, double width, double depth, String material, String franchise) {
