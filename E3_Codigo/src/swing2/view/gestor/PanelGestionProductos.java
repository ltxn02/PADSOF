...
/**
 * Panel de gestión de productos para el gestor/manager.
 * Basado en PanelProductosEmpleado con paleta de colores del dashboard.
 */
public class PanelGestionProductos extends JPanel {
	...
	public PanelGestionProductos(VentanaPrincipa ventana) {
		this.ventana = ventana;
		this.setLayout(new BorderLayout());
		this.setBackground(COLOR_FONDO);

		// Crear panel de tabla de productos
		this.add(crearPanelTablaProductos(), BorderLayout.CENTER);
	}

	// ==========================================
	// VISTA: LA TABLA DE PRODUCTOS
	// ==========================================
	private JPanel crearPanelTablaProductos() {
		...
		btnAnadir.addActionListener(e -> JOptionPane.showMessageDialog(this, "Próximamente: Añadir nuevo producto"));
		btnRefrescar.addActionListener(e -> {
			// Refrescar la tabla
			Container parent = this.getParent();
			if (parent != null) {
				parent.removeAll();
				parent.add(crearPanelTablaProductos(), BorderLayout.CENTER);
				parent.revalidate();
				parent.repaint();
			}
		});
		...
		// Panel de tabla con cabecera y filas
		JPanel pnlTabla = new JPanel(new BorderLayout());
		pnlTabla.setOpaque(false);
		pnlTabla.setBackground(COLOR_FONDO);
